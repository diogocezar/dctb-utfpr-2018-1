...
import controladores.GerenciadorDeConta;
...
public class Main {
    ...
    private static void removerConta() {
        try {
            String numeroDaConta = solicitarNumeroDaConta();
    ...
    private static void criarNovaConta() {
        String numero = solicitarNumeroDaConta();
    ...
    private static String solicitarNumeroDaConta() {
