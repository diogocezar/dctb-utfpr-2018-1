...
class MenuDemo implements ActionListener {
    ...
    MenuDemo() {
        ...
        JCheckBoxMenuItem jmiVerm = new JCheckBoxMenuItem("Vermelho", true);
        JCheckBoxMenuItem jmiAzul = new JCheckBoxMenuItem("Azul");
        JCheckBoxMenuItem jmiVerde = new JCheckBoxMenuItem("Verde");
        ...
        JRadioButtonMenuItem jmiAlta = new JRadioButtonMenuItem("Alta",true);
        JRadioButtonMenuItem jmiBaixa = new JRadioButtonMenuItem("Baixa");
