...
public class Main {
	...
	private static void listarContas(){
		String todasAsContas = gerenciador.listaContas();
	...
	private static void removerConta(){
		try {
			...
			gerenciador.excluiConta(numeroDaConta);
		} catch (Exception e) {
	...
	private static void alterarNomeDoTitular(){
		try {
			...
			gerenciador.mudaTitular(numeroDaConta, novoNomeDoTitular);
	...
	private static void consultarAgencia(){
		try {
			int numeroDaConta = solicitarNumeroDaConta();
			String nomeDaAgencia = gerenciador.procuraAgencia(numeroDaConta);
	...
	private static void consultarSaldo(){
		try {
			int numeroDaConta = solicitarNumeroDaConta();
			double saldo = gerenciador.procuraSaldo(numeroDaConta);
	...
	private static void criarNovaConta(){
		...
		gerenciador.criaConta(titular, agencia, numero, saldo);
	}
	...
	private static String solicitarNomeDaAgencia(){
		String agencia = JOptionPane.showInputDialog(null, "Nome da Agência: ");
		return agencia;
	}
