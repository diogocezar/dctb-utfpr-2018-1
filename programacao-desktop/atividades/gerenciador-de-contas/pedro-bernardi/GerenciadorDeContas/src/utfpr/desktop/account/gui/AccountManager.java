package utfpr.desktop.account.gui;

import utfpr.desktop.account.controllers.AccountControl;
import javax.swing.JOptionPane;

public class AccountManager {

    private static AccountControl gerenciador = new AccountControl();
    ...
    private static void listarContas(){
        String todasAsContas = gerenciador.listAccounts();
    ...
    private static void removerConta(){
        try {
            ...
            gerenciador.removeAccount(numeroDaConta);
        } catch (Exception e) {
    ...
    private static void alterarNomeDoTitular(){
        try {
            ...
            gerenciador.updateName(numeroDaConta, novoNomeDoTitular);
    ...
    private static void consultarAgencia(){
        try {
            int numeroDaConta = solicitarNumeroDaConta();
            String nomeDaAgencia = gerenciador.searchSchedule(numeroDaConta);
    ...
    private static void consultarSaldo(){
        try {
            int numeroDaConta = solicitarNumeroDaConta();
            double saldo = gerenciador.searchBalance(numeroDaConta);
    ...
    private static void criarNovaConta(){
        ...
        gerenciador.createAccount(titular, agencia, saldo);
    }
