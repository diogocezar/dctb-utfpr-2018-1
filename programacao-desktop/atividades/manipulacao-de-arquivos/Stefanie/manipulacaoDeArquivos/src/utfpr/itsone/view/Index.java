...
import utfpr.itsone.data.controller.config.ArquivoBinario;
import utfpr.itsone.data.controller.config.ArquivoJson;
import utfpr.itsone.data.controller.config.ArquivoTexto;
...
public class Index extends JFrame {
    ...
    public static final String NAME = "Manipulacao de Arquivos - Trabalho";
    ...
    private void init() {
        ...
        menuBar.setBackground(new Color(0x000198));
