...
public class Index extends JFrame {
    ...
    private void init() {
        ...
        menuBar.setBackground(new Color(0x000715));
        ...
        //saveMenu.setBackground(new Color(0x000715));
        ...
        saveMenu.addItemListener((e) -> {
            //statusSave = ((JCheckBoxMenuItem) e.getItem()).isSelected();
            //JOptionPane.showMessageDialog(null, statusSave);
        });
        ...
        text.setAccelerator(KeyStroke.getKeyStroke('T', Toolkit
        ...
        bin.setAccelerator(KeyStroke.getKeyStroke('B', Toolkit
                .getDefaultToolkit().getMenuShortcutKeyMask()));
        ...
        json.setAccelerator(KeyStroke.getKeyStroke('J', Toolkit
                .getDefaultToolkit().getMenuShortcutKeyMask()));
