...
public class InterfacePokemon extends JFrame{
    ...
    private final Dimension dJTxt = new Dimension(200, 40);
    private final Dimension dButtons = new Dimension(100, 40);
    private final Border borda = BorderFactory.createLineBorder(Color.black);
    //Componentes
    ...
    private void initComponents(){
        ...
        modelo.setColumnIdentifiers(new String[]{"Id", "Nome", "Nivel", "HP", "Agility", "Attack", "Defense", "SpecialAttack", "SpecialDefense"});
