...
public class PokemonController {
    ...
    public void update(){
        ...
        p.setId(Integer.parseInt(panel.getTxtId().getText()));
        p.setName(panel.getTxtName().getText());
        
        p.setLevel(Integer.parseInt(panel.getTxtLevel().getText()));
        p.setHp(Integer.parseInt(panel.getTxtHp().getText()));
        p.setAgility(Integer.parseInt(panel.getTxtAgility().getText()));
        p.setAttack(Integer.parseInt(panel.getTxtAttack().getText()));
        p.setDefense(Integer.parseInt(panel.getTxtDefense().getText()));
        p.setSpecialAttack(Integer.parseInt(panel.getTxtSpecialAttack().getText()));
        p.setSpecialDefense(Integer.parseInt(panel.getTxtSpecialDefense().getText()));
        implementPokemon.update(p);
    ...
    public void getData(){
        if (panel.getTxtName().getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(panel, "Digite um nome de um pokemon para buscar.", null, JOptionPane.WARNING_MESSAGE);
            return;
        }
