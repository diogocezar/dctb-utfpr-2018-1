...
public class PokemonDAO implements ImplementPokemon{
    ...
    public void insert(Pokemon pokemon) {
        this.db.execute("INSERT INTO java_pokemon (name) VALUES (?)", pokemon.getName());
    }

    @Override
    public void update(Pokemon pokemon) {
        this.db.execute("UPDATE java_pokemon SET name=? WHERE id=?", pokemon.getName(), pokemon.getId());
    }
    ...
    public List<Pokemon> getAllPokemon() {
        ...
        try {
            ...
            System.out.println("Erro ao retornar um  pelo nome: " + ex.getMessage());
        }
        return null;
    }
}
